...
import { Target, Award, Heart, Users, ShieldCheck, Monitor, Smile, Star, BookOpen, Cpu } from 'lucide-react';
    ...
    <div>
      ...
      <Section background="grey">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="bg-white p-8 rounded-xl shadow-md hover:-translate-y-1 transition-transform duration-300">
      ...
      <Section background="white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={idx} className="flex items-start gap-4 p-6 border border-gray-100 rounded-xl hover:shadow-lg transition-all duration-300 group">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-school-gold shadow-sm"><Smile size={20} /></div>
                <span className="font-semibold text-gray-800">Child-Centered Learning</span>
              </div>
              <div className="flex items-center gap-3">
                 <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-school-gold shadow-sm"><Cpu size={20} /></div>
                <span className="font-semibold text-gray-800">Technology-Enhanced Teaching</span>
              </div>
              <div className="flex items-center gap-3">
                 <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-school-gold shadow-sm"><BookOpen size={20} /></div>
                <span className="font-semibold text-gray-800">Practical, Hands-On Experiences</span>
              </div>
               <div className="flex items-center gap-3">
                 <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-school-gold shadow-sm"><Star size={20} /></div>
                <span className="font-semibold text-gray-800">Focus on Academics + Character</span>
              </div>
            </div>
          </div>
          <div className="bg-white p-8 rounded-2xl shadow-lg border-t-8 border-school-gold">
      ...
      <Section background="white" className="pt-0">
        <div className="bg-yellow-50 p-10 rounded-2xl border-l-8 border-school-gold">
          <h2 className="text-2xl font-bold text-school-dark mb-4">Message from the Head of School</h2>
          ...
          <p className="font-bold text-school-dark">- The Headmaster</p>
        </div>
      </Section>
    </div>
  );
